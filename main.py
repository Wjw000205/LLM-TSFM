...
def get_args():
    ...
    add("--use_event_weighted_loss", type=int, default=config.get("use_event_weighted_loss", 0))
    add("--use_zero_consistency_loss", type=int, default=config.get("use_zero_consistency_loss", 0))
    add("--use_peak_shape_loss", type=int, default=config.get("use_peak_shape_loss", 0))
    add("--use_diff_loss", type=int, default=config.get("use_diff_loss", 0))
    add("--use_freq_loss", type=int, default=config.get("use_freq_loss", 0))
    add("--event_weight", type=float, default=config.get("event_weight", 1.0))
    add("--zero_weight", type=float, default=config.get("zero_weight", 1.0))
    add("--peak_weight", type=float, default=config.get("peak_weight", 1.0))
    add("--diff_weight", type=float, default=config.get("diff_weight", 1.0))
    add("--freq_weight", type=float, default=config.get("freq_weight", 1.0))
