...
def get_args():
    ...
    add("--use_intervention_layer", type=int, default=config.get("use_intervention_layer", 0))
    add("--intervention_hidden", type=int, default=config.get("intervention_hidden", 32))
    add("--intervention_dropout", type=float, default=config.get("intervention_dropout", 0.0))
    add("--intervention_scale", type=float, default=config.get("intervention_scale", 1.0))
    add("--intervention_init_zero", type=int, default=config.get("intervention_init_zero", 1))
    add("--use_intervention_reg", type=int, default=config.get("use_intervention_reg", 0))
    add("--intervention_reg_weight", type=float, default=config.get("intervention_reg_weight", 0.0))
    add("--train_only_intervention", type=int, default=config.get("train_only_intervention", 0))
    add("--use_rule_prior_fusion", type=int, default=config.get("use_rule_prior_fusion", 0))
    add("--rule_prior_alpha", type=float, default=config.get("rule_prior_alpha", 0.5))
    add("--rule_prior_use_confidence", type=int, default=config.get("rule_prior_use_confidence", 0))
    add("--rule_prior_types", type=str, default=config.get("rule_prior_types", "zero_event"))
    add("--rule_prior_mode", type=str, default=config.get("rule_prior_mode", "fixed"), choices=["fixed", "calibrated"])
    add("--validated_rule_path", type=str, default=config.get("validated_rule_path", None))
    add("--disable_invalid_rules", type=int, default=config.get("disable_invalid_rules", 1))
    ...
    add("--use_soft_event_weighted_loss", type=int, default=config.get("use_soft_event_weighted_loss", None))
    ...
    add("--soft_event_weight", type=float, default=config.get("soft_event_weight", None))
    add("--soft_event_feature_regex", type=str, default=config.get("soft_event_feature_regex", "soft_event_score"))
    add("--soft_event_power", type=float, default=config.get("soft_event_power", 1.0))
    ...
    add("--use_shift_aware_rule", type=int, default=config.get("use_shift_aware_rule", 0))
    add("--rule_shift_steps", type=int, default=config.get("rule_shift_steps", 0))
